...
<h3 class="oxanium">Masker Kain</h3>
</div>
<div class="carousel-container">
<div id="myCarouselc" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
      <div class="item active">
        <a href="assets/i/pr/mk/maskerkain01.jpg" target="_BLANK"><img src="assets/i/pr/mk/maskerkain01.jpg" alt=""></a>
        <div class="carousel-caption">
          <h3></h3>
          <p></p>
        </div>
      ...
      <div class="item">
        <a href="assets/i/pr/mk/maskerkain02.jpg" target="_BLANK"><img src="assets/i/pr/mk/maskerkain02.jpg" alt=""></a>
        <div class="carousel-caption">
          <h3></h3>
          <p></p>
        </div>
      ...
      <div class="item">
        <a href="assets/i/pr/mk/maskerkain03.jpg" target="_BLANK"><img src="assets/i/pr/mk/maskerkain03.jpg" alt=""></a>
        <div class="carousel-caption">
          <h3></h3>
          <p></p>
        </div>
      ...
      <div class="item">
        <a href="assets/i/pr/mk/maskerkain04.jpg" target="_BLANK"><img src="assets/i/pr/mk/maskerkain04.jpg" alt=""></a>
        <div class="carousel-caption">
          <h3></h3>
          <p></p>
        </div>
      ...
      <div class="item">
        <a href="assets/i/pr/mk/maskerkain05.jpg" target="_BLANK"><img src="assets/i/pr/mk/maskerkain05.jpg" alt=""></a>
        <div class="carousel-caption">
          <h3></h3>
          <p></p>
        </div>
...
<div class="page-60">
    <h4 class="oxanium azure">
        ...
        Dijamin kualitas terbaik.</h4><br/><br/>
        <h4 class="oxanium azure">Varian: 
            <a href="https://s.id/soj-tus1" target="_BLANK">1 Kg (Rp. 80.000)</a> | 
            <a href="https://s.id/soj-tus2" target="_BLANK">500 g (Rp. 42.000)</a> | 
            <a href="https://s.id/soj-tus3" target="_BLANK">250 g (Rp. 25.000)</a>
        </h4>
</div>
<div class="page-20"></div>
</div>`;
...
<div class="page-60">
    <h4 class="oxanium azure">Cabe Jawa/Cabe Jamu<br/>
        ...
        <h4 class="oxanium azure">Varian: 
            <a href="https://s.id/soj-cjw1" target="_BLANK">1 Kg (Rp. 55.000)</a> | 
            <a href="https://s.id/soj-cjw2" target="_BLANK">500 g (Rp. 35.000)</a> | 
            <a href="https://s.id/soj-cjw3" target="_BLANK">300 g (Rp. 25.000)</a>
        </h4>
</div>
<div class="page-20"></div>
</div>`;
...
<div class="page-60">
    <h4 class="oxanium azure">
        Masker kain<br/>
        <br/>
        > PRE ORDER karena dijahit sendiri<br/>
        <br/>
        > Terbuat dari bahan katun,<br/>
        > Terdiri dari 2 lapis kain,<br/>
        > Terdapat lubang pada bagian tengah untuk memasukkan filter tambahan,<br/>
        > Dapat dicuci untuk pemakaian jangka panjang.<br/>
        <br/>
        > Terdapat 2 varian mode : Mode Biasa (dikaitkan ke telinga) dan Mode Hijab.<br/>
        <br/>
        > Terdapat 7 varian warna : merah hati, biru, hijau toska, hitam, kuning (agak krem), motif kotak, motif bunga.</h4><br/><br/>
        <h4 class="oxanium azure">Varian: 
            <a href="https://s.id/soj-msk1" target="_BLANK">Semua varian (Rp. 45.000)</a>
        </h4>
</div>
<div class="page-20"></div>
</div>`;
...
<div class="page-60">
    <h4 class="oxanium azure">
        Wayang Kulit asli 1 kotak / 1 set isi 200 an<br/>
        <br/>
        > Kondisi masih bagus<br/>
        > bonus 1 set panggung wayang<br/>
        > bonus 1 set geber<br/>
        > Bekas pemakaian standar pedalangan<br/>
        > Lokasi Puger<br/>
        > Harga Rp. 75.000.000<br/>
        <br/>
        *Untuk nego hubungi [SMS / WA] 085230651250 atau klik <a href="https://s.id/soj-wyg1-nego" target="_BLANK">di sini.</a></h4><br/><br/>
        <h4 class="oxanium azure">Link: 
            <a href="https://s.id/soj-wyg1" target="_BLANK">Tokped</a>
        </h4>
</div>
<div class="page-20"></div>
</div>`;
...
function insertc(){
    ...
    indukDetail.setAttribute('class', 'page detail-masker last-page');
    indukCarousel.scrollIntoView();
}
